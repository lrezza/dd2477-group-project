...
'''
Note that the path here a little differnt from the orginal inexer
I add the entire path in order to indexing the transcrips    
'''
podcast_data_dir = "Path to transcripts"
